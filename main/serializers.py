...
class ProductSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        representation['reviews'] = ReviewSerializer(instance.reviews.all(), many=True, context={"request":request}).data
        ...
        if request:
            if request.user.is_authenticated:
                ...
                representation['favorite_by_user'] = Favorite.objects.filter(user=request.user, favorite=True, product=instance).exists()
